...
// drawDB's own import validator. Kept so the test suite can assert that what
// this server writes is what the GUI will accept — the guarantee the whole
// file-based design rests on.
// @ts-nocheck
